;Generated with /home/philipp/reve-horn/simpl/horn --invariants=local --templates reversearray_1.spl reversearray_2.spl
;On Thu Jan 14 15:58:32 2016
;By mohit
                    ...
                    (and 
                     (forall 
                      ...
                      (INV1 $i2 
                       ...
                       (select $heap$2_1 $i1) n$2_1 a$2_1 i$2_2 j$2_2 C$2_2 comparisoncost$2_2 divisioncost$2_2 assigncost$2_2 minusminuscost$2_2 t$2_2))
                     (forall 
                      (
                       ($heap$1_2 
                        (Array Int Int)) 
                        ...
                        (and 
                         (forall 
                          ...
                          (INV1 $i2 
                           ...
                           (select $heap$2_2 $i1) n$2_2 a$2_2 i$2_3 j$2_3 C$2_3 comparisoncost$2_3 divisioncost$2_3 assigncost$2_3 minusminuscost$2_3 t$2_3)) 
                         (< i$2_3 
                          (div n$2_2 2)) 
                         (< i$1_3 j$1_3)) 
                        (let 
                                        ...
                                        (let 
                                         ...
                                         (forall 
                                          (
                                           ...
                                           ($i1 Int)) 
                                          (INV1 $i2 
                                           (select $heap$1_4 $i2) n$1_2 a$1_2 i$1_4 j$1_4 C$1_7 comparisoncost$1_3 minusminuscost$1_3 assigncost$1_3 pluspluscost$1_3 t$1_4 $i1 
                                           (select $heap$2_4 $i1) n$2_2 a$2_2 i$2_3 j$2_4 C$2_7 comparisoncost$2_3 divisioncost$2_3 assigncost$2_3 minusminuscost$2_3 t$2_4)))))))))))))))))))) 
                       (=> 
                        (and 
                         (forall 
                          (

;Generated with /home/philipp/reve-horn/simpl/horn --invariants=local --templates memcpyb_1.spl memcpyb_2.spl
;On Tue Jan 12 16:15:33 2016
;By mohit
                  ...
                  (and 
                   (forall 
                    ...
                    (INV1 $i2 
                     ...
                     (select $heap$2_1 $i1) dest$2_2 src$2_2 size$2_1 C$2_4 comparisoncost$2_2 assigncost$2_2 pluspluscost$2_2 minusminuscost$2_2))
                   (forall 
                    (
                     ($heap$1_2 
                      (Array Int Int)) 
                      ...
                      (and 
                       (forall 
                        ...
                        (INV1 $i2 
                         ...
                         (select $heap$2_2 $i1) dest$2_3 src$2_3 size$2_2 C$2_5 comparisoncost$2_3 assigncost$2_3 pluspluscost$2_3 minusminuscost$2_3)) 
                       (> size$2_2 0) 
                       (< i$1_3 size$1_2)) 
                      (let 
                       (
                         ...
                         (let 
                          ...
                          (let 
                           ...
                           (let 
                            (
                             ($heap$2_3 
                              (store $heap$2_2 dest$2_4 
                               (select $heap$2_2 src$2_4)))) 
                            (let 
                             (
                              (C$2_9 
                                   ...
                                   (let 
                                    ...
                                    (forall 
                                     ...
                                     (INV1 $i2 
                                      ...
                                      (select $heap$2_3 $i1) dest$2_4 src$2_4 size$2_3 C$2_10 comparisoncost$2_3 assigncost$2_3 pluspluscost$2_3 minusminuscost$2_3))))))))))))))))) 
                     (=> 
                      (and 
                       (forall 
                        (

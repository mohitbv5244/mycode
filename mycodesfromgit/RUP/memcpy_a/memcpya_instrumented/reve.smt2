;Generated with /home/philipp/reve-horn/simpl/horn --invariants=local --templates memcpya_1.spl memcpya_2.spl
;On Tue Mar 15 00:51:01 2016
;By mohit
               ...
               (and 
                (forall 
                 ...
                 (INV1 $i2 
                  ...
                  (select $heap$2_1 $i1) dest$2_1 src$2_1 size$2_1 C$2_2 comparisoncost$2_2 assigncost$2_2 pluspluscost$2_2 readingcost$2_2 i$2_2))
                (forall 
                 (
                  ($heap$1_2 
                   (Array Int Int)) 
                   ...
                   (and 
                    (forall 
                     ...
                     (INV1 $i2 
                      ...
                      (select $heap$2_2 $i1) dest$2_2 src$2_2 size$2_2 C$2_3 comparisoncost$2_3 assigncost$2_3 pluspluscost$2_3 readingcost$2_3 i$2_3)) 
                    (not 
                     (= 
                      (select $heap$2_2 
                       (+ src$2_2 i$2_3)) 0)) 
                   ...
                   (let 
                    ...
                    (let 
                     ...
                     (let 
                      (
                       ($heap$2_3 
                        (store $heap$2_2 dest$2_2 
                         (select $heap$2_2 src$2_2)))) 
                      (let 
                       (
                        (C$2_6 
                             ...
                             (let 
                              ...
                              (forall 
                               (
                                ...
                                ($i1 Int)) 
                               (INV1 $i2 
                                (select $heap$1_3 $i2) dest$1_2 src$1_2 size$1_2 i$1_4 C$1_6 comparisoncost$1_3 assigncost$1_3 pluspluscost$1_3 $i1 
                                (select $heap$2_3 $i1) dest$2_2 src$2_2 size$2_2 C$2_7 comparisoncost$2_3 assigncost$2_3 pluspluscost$2_3 readingcost$2_3 i$2_4)))))))))))))) 
                  (=> 
                   (and 
                    (forall 
                     (

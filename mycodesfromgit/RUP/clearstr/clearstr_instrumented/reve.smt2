;Generated with /home/philipp/reve-horn/simpl/horn --invariants=local --templates clearstr_1.spl clearstr_2.spl
;On Tue Jan 12 17:02:06 2016
;By mohit
                               ...
                               (let 
                                ...
                                (forall 
                                 (
                                  ...
                                  ($i1 Int)) 
                                 (INV1 $i2 
                                  (select $heap$1_3 $i2) a$1_2 i$1_4 C$1_7 comparisoncost$1_3 pluspluscost$1_3 readingcost$1_3 assigncost$1_3 $i1 
                                  (select $heap$2_3 $i1) a$2_3 a0$2_3 C$2_7 comparisoncost$2_3 assigncost$2_3 pluspluscost$2_3 readingcost$2_3))))))))))))))) 
                   (=> 
                    (and 
                     (forall 
                      (
